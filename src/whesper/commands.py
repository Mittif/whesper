...
COMMAND_SPECS: tuple[CommandSpec, ...] = (
    ...
    CommandSpec("/cup-status", description="Read the current CUP system and motor status"),
    CommandSpec("/cup-speed", "<velocity>", "Set CUP motor target velocity and enable it"),
    CommandSpec("/cup-stop", description="Emergency stop the CUP motor"),
    ...
    CommandSpec("/session", "[session_id]", "Show current session ID or switch to an existing session"),
...
def command_completions(
    ...
    return {
        ...
        "/copy-last": None,
        "/cup-status": None,
        "/cup-speed": {"20": None, "40": None, "70": None, "110": None},
        "/cup-stop": None,
        "/cup-scene": {
            "gentle": None,
            "steady": None,
        ...
        "/cup-intensity": {"up": None, "down": None},
        "/cup-led": {
            "warmwhite": None,
            "#ffb36b": None,
            "#40c4ff": None,
        ...
        "/session": {session_id: None for session_id in store.list_sessions()},
